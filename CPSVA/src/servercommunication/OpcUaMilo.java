...
public class OpcUaMilo {
	...
	public static UANode defineNode(NodeId serverNodeId) {
		...
		case 128:
			...
			try {
				...
				viewNode.setEventNotifier((short) response.get().getResults()[0].getValue().getValue());
	...
	public static String formatNodeId(int ns, String identifierType, String identifer) {
		String nodeId = null;
		
		switch (identifierType) {
		case "Numeric":
			nodeId = "ns=" + ns + ";i=" + identifer;
			break;
		case "String":
			nodeId = "ns=" + ns + ";s=" + identifer;
			break;
		case "Guid":
			nodeId = "ns=" + ns + ";s=" + identifer;
			break;
